...
The Application accepts just one argument. This can be either a [Container](/docs/v4/concepts/di.html) instance or
...
<dt><code>httpVersion</code></dt>
    <dd>The protocol version used by the <a href="/docs/v4/objects/response.html">Response</a>
        object.
...
<dt><code>displayErrorDetails</code></dt>
    ...
    <a href="/docs/v4/handlers/error.html">default error handler</a>.
    <br>(Default: <code>false</code>)</dd>
